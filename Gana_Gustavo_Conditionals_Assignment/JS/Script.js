...
console.log("A single piece of armor cost " + armor + " dollars");
var gun = 800;// var for gun cost
console.log("A single gun cost " + gun + " dollars");
...
var armorCount = bonus / armor;// devided armor and bonus to see how many i can buy
