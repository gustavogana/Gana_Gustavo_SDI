...
console.log("Your BMI is " + bmi);//display user bmi.
...
console.log("You have to burn a total of " + poundsLoose + " calories");//text displaying total calories need to burn.
alert("You have to burn a total of " + poundsLoose + " calories");//alert displaying calories needed to burn.
var exersise = prompt("How many hours per week will you exercise?");//asking how many hours per week the user will exercise.
...
console.log("That's an average of " + averageCal + " calories to burn per day");//text displaying calories per day to burn.
var exercises = [255, 400, 388];//three different exercise calories burn in 3 hours.
var totalExercises = exercises[0] += exercises[1] += exercises[2];//added all the exercises.
alert("Helpful tip \ntotal calories burned doing three different exercises for 3 hours is " + totalExercises);//alert with tip for user.
console.log("total calories burned doing three different exercises for 3 hours is " + totalExercises);//text display tip for user.